...
function ShaderBox(props) {
  ...
  useFrame((state, delta) => {
    ...
    ref.current.material.uniforms.fogRange.value = props.materialData.fogRange;
    ...
    ref.current.material.uniforms.DEEP_COLOR.value = props.materialData.deepColor;
